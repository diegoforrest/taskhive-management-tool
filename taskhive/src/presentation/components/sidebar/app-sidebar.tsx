...
import { Collapsible, CollapsibleContent } from "@/presentation/components/ui/collapsible"
import { DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem } from "@/presentation/components/ui/dropdown-menu"
...
export function AppSidebar() {
  ...
  useEffect(() => {
    const loadUserProjects = async () => {
      ...
      try {
        ...
        const projectsResponse = await authApi.getProjects(user.id);
  ...
  setUserProjects(transformedProjects)
    ...
    loadUserProjects()
  }, [user?.id, isAuthenticated, refreshKey]) // Added refreshKey as dependency
  ...
  useEffect(() => {
    ...
    const handleVisibilityChange = () => {
      if (!document.hidden && user?.id && isAuthenticated) {
